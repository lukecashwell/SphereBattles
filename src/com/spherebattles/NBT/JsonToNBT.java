...
public class JsonToNBT {
   public static final SimpleCommandExceptionType ERROR_TRAILING_DATA = new SimpleCommandExceptionType(() -> ("argument.nbt.trailing"));
   public static final SimpleCommandExceptionType ERROR_EXPECTED_KEY = new SimpleCommandExceptionType(() -> ("argument.nbt.expected.key"));
   public static final SimpleCommandExceptionType ERROR_EXPECTED_VALUE = new SimpleCommandExceptionType(() -> ("argument.nbt.expected.value"));
   public static final Dynamic2CommandExceptionType ERROR_INSERT_MIXED_LIST = new Dynamic2CommandExceptionType((p_208775_0_, p_208775_1_) -> {
      return () -> ("argument.nbt.list.mixed");
   });
   ...
   protected INBTBase readList() throws CommandSyntaxException {
      return this.reader.canRead(3) && this.reader.peek(2) == ';' ? this.readArrayTag() : this.readListTag();
   }
   ...
   private INBTBase readArrayTag() throws CommandSyntaxException {
      ...
      if (!this.reader.canRead()) {
         ...
         return new NBTTagIntArray(this.readArray((byte)11, (byte)3));
          ...
          return new NBTTagStringArray(this.readArray((byte)13, (byte)8));
      } else {
         this.reader.setCursor(i);
...
private <T> List<T> readArray(byte p_193603_1_, byte p_193603_2_) throws CommandSyntaxException {
      ...
      while(true) {
         if (this.reader.peek() != ']') {
            ...
            } else if (p_193603_2_ == 3) {
               list.add((T)Integer.valueOf(((NBTPrimitive)inbtbase).getInt()));
            } else if (p_193603_2_ == 8) {
                list.add((T)((NBTPrimitive)inbtbase).getString());
             }
